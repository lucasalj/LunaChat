...
set(CONAN_RANGE-V3_ROOT "/home/lucas/.conan/data/range-v3/0.5.0/ericniebler/stable/package/108b10878ddfbada81a0ed2fb115999aafcd316c")
set(CONAN_INCLUDE_DIRS_RANGE-V3 "/home/lucas/.conan/data/range-v3/0.5.0/ericniebler/stable/package/108b10878ddfbada81a0ed2fb115999aafcd316c/include")
set(CONAN_LIB_DIRS_RANGE-V3 "/home/lucas/.conan/data/range-v3/0.5.0/ericniebler/stable/package/108b10878ddfbada81a0ed2fb115999aafcd316c/lib")
set(CONAN_BIN_DIRS_RANGE-V3)
set(CONAN_RES_DIRS_RANGE-V3)
set(CONAN_SRC_DIRS_RANGE-V3)
set(CONAN_BUILD_DIRS_RANGE-V3 "/home/lucas/.conan/data/range-v3/0.5.0/ericniebler/stable/package/108b10878ddfbada81a0ed2fb115999aafcd316c/")
...
set(CONAN_BOOST_ROOT "/home/lucas/.conan/data/boost/1.71.0/conan/stable/package/2e1777b52bec46a45440dc252927f1c4bdda05d8")
set(CONAN_INCLUDE_DIRS_BOOST "/home/lucas/.conan/data/boost/1.71.0/conan/stable/package/2e1777b52bec46a45440dc252927f1c4bdda05d8/include")
set(CONAN_LIB_DIRS_BOOST "/home/lucas/.conan/data/boost/1.71.0/conan/stable/package/2e1777b52bec46a45440dc252927f1c4bdda05d8/lib")
set(CONAN_BIN_DIRS_BOOST)
set(CONAN_RES_DIRS_BOOST)
set(CONAN_SRC_DIRS_BOOST)
set(CONAN_BUILD_DIRS_BOOST "/home/lucas/.conan/data/boost/1.71.0/conan/stable/package/2e1777b52bec46a45440dc252927f1c4bdda05d8/")
...
set(CONAN_CATCH2_ROOT "/home/lucas/.conan/data/Catch2/2.9.1/catchorg/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_CATCH2 "/home/lucas/.conan/data/Catch2/2.9.1/catchorg/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
set(CONAN_LIB_DIRS_CATCH2 "/home/lucas/.conan/data/Catch2/2.9.1/catchorg/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/lib")
set(CONAN_BIN_DIRS_CATCH2)
set(CONAN_RES_DIRS_CATCH2)
set(CONAN_SRC_DIRS_CATCH2)
set(CONAN_BUILD_DIRS_CATCH2 "/home/lucas/.conan/data/Catch2/2.9.1/catchorg/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
...
set(CONAN_BITSERY_ROOT "/home/lucas/.conan/data/bitsery/5.0.3/lib/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9")
set(CONAN_INCLUDE_DIRS_BITSERY "/home/lucas/.conan/data/bitsery/5.0.3/lib/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/include")
set(CONAN_LIB_DIRS_BITSERY)
set(CONAN_BIN_DIRS_BITSERY)
set(CONAN_RES_DIRS_BITSERY)
set(CONAN_SRC_DIRS_BITSERY)
set(CONAN_BUILD_DIRS_BITSERY "/home/lucas/.conan/data/bitsery/5.0.3/lib/stable/package/5ab84d6acfe1f23c4fae0ab88f26e3a396351ac9/")
set(CONAN_LIBS_BITSERY)
set(CONAN_DEFINES_BITSERY)
# COMPILE_DEFINITIONS are equal to CONAN_DEFINES without -D, for targets
set(CONAN_COMPILE_DEFINITIONS_BITSERY)

set(CONAN_C_FLAGS_BITSERY "")
set(CONAN_CXX_FLAGS_BITSERY "-std=c++17")
set(CONAN_SHARED_LINKER_FLAGS_BITSERY "")
set(CONAN_EXE_LINKER_FLAGS_BITSERY "")

# For modern cmake targets we use the list variables (separated with ;)
set(CONAN_C_FLAGS_BITSERY_LIST "")
set(CONAN_CXX_FLAGS_BITSERY_LIST "-std=c++17")
...
set(CONAN_BUILD_DIRS_ZLIB "/home/lucas/.conan/data/zlib/1.2.11/conan/stable/package/1d877a3df840030e6a8abb74c5ffb9088d08b47a/")
...
set(CONAN_BZIP2_ROOT "/home/lucas/.conan/data/bzip2/1.0.8/conan/stable/package/a5875aed3fc7ae8dd0488f7e5e99acbc480d721d")
set(CONAN_INCLUDE_DIRS_BZIP2 "/home/lucas/.conan/data/bzip2/1.0.8/conan/stable/package/a5875aed3fc7ae8dd0488f7e5e99acbc480d721d/include")
set(CONAN_LIB_DIRS_BZIP2 "/home/lucas/.conan/data/bzip2/1.0.8/conan/stable/package/a5875aed3fc7ae8dd0488f7e5e99acbc480d721d/lib")
set(CONAN_BIN_DIRS_BZIP2 "/home/lucas/.conan/data/bzip2/1.0.8/conan/stable/package/a5875aed3fc7ae8dd0488f7e5e99acbc480d721d/bin")
set(CONAN_RES_DIRS_BZIP2)
set(CONAN_SRC_DIRS_BZIP2)
set(CONAN_BUILD_DIRS_BZIP2 "/home/lucas/.conan/data/bzip2/1.0.8/conan/stable/package/a5875aed3fc7ae8dd0488f7e5e99acbc480d721d/")
...
set(CONAN_INCLUDE_DIRS "/home/lucas/.conan/data/range-v3/0.5.0/ericniebler/stable/package/108b10878ddfbada81a0ed2fb115999aafcd316c/include"
...
macro(conan_define_targets)
    ...
    conan_package_library_targets("${CONAN_LIBS_BITSERY}" "${CONAN_LIB_DIRS_BITSERY}"
            CONAN_PACKAGE_TARGETS_BITSERY "" "" bitsery)
    conan_package_library_targets("${CONAN_LIBS_BITSERY_DEBUG}" "${CONAN_LIB_DIRS_BITSERY_DEBUG}"
            CONAN_PACKAGE_TARGETS_BITSERY_DEBUG "" "debug" bitsery)
    conan_package_library_targets("${CONAN_LIBS_BITSERY_RELEASE}" "${CONAN_LIB_DIRS_BITSERY_RELEASE}"
            CONAN_PACKAGE_TARGETS_BITSERY_RELEASE "" "release" bitsery)
    conan_package_library_targets("${CONAN_LIBS_BITSERY_RELWITHDEBINFO}" "${CONAN_LIB_DIRS_BITSERY_RELWITHDEBINFO}"
            CONAN_PACKAGE_TARGETS_BITSERY_RELWITHDEBINFO "" "relwithdebinfo" bitsery)
    conan_package_library_targets("${CONAN_LIBS_BITSERY_MINSIZEREL}" "${CONAN_LIB_DIRS_BITSERY_MINSIZEREL}"
            CONAN_PACKAGE_TARGETS_BITSERY_MINSIZEREL "" "minsizerel" bitsery)

    add_library(CONAN_PKG::bitsery INTERFACE IMPORTED)

    # Property INTERFACE_LINK_FLAGS do not work, necessary to add to INTERFACE_LINK_LIBRARIES
    set_property(TARGET CONAN_PKG::bitsery PROPERTY INTERFACE_LINK_LIBRARIES ${CONAN_PACKAGE_TARGETS_BITSERY} ${CONAN_SHARED_LINKER_FLAGS_BITSERY_LIST} ${CONAN_EXE_LINKER_FLAGS_BITSERY_LIST}
            $<$<CONFIG:Release>:${CONAN_PACKAGE_TARGETS_BITSERY_RELEASE} ${CONAN_SHARED_LINKER_FLAGS_BITSERY_RELEASE_LIST} ${CONAN_EXE_LINKER_FLAGS_BITSERY_RELEASE_LIST}>
            $<$<CONFIG:RelWithDebInfo>:${CONAN_PACKAGE_TARGETS_BITSERY_RELWITHDEBINFO} ${CONAN_SHARED_LINKER_FLAGS_BITSERY_RELWITHDEBINFO_LIST} ${CONAN_EXE_LINKER_FLAGS_BITSERY_RELWITHDEBINFO_LIST}>
            $<$<CONFIG:MinSizeRel>:${CONAN_PACKAGE_TARGETS_BITSERY_MINSIZEREL} ${CONAN_SHARED_LINKER_FLAGS_BITSERY_MINSIZEREL_LIST} ${CONAN_EXE_LINKER_FLAGS_BITSERY_MINSIZEREL_LIST}>
            $<$<CONFIG:Debug>:${CONAN_PACKAGE_TARGETS_BITSERY_DEBUG} ${CONAN_SHARED_LINKER_FLAGS_BITSERY_DEBUG_LIST} ${CONAN_EXE_LINKER_FLAGS_BITSERY_DEBUG_LIST}>
            )
    set_property(TARGET CONAN_PKG::bitsery PROPERTY INTERFACE_INCLUDE_DIRECTORIES ${CONAN_INCLUDE_DIRS_BITSERY}
            $<$<CONFIG:Release>:${CONAN_INCLUDE_DIRS_BITSERY_RELEASE}>
            $<$<CONFIG:RelWithDebInfo>:${CONAN_INCLUDE_DIRS_BITSERY_RELWITHDEBINFO}>
            $<$<CONFIG:MinSizeRel>:${CONAN_INCLUDE_DIRS_BITSERY_MINSIZEREL}>
            $<$<CONFIG:Debug>:${CONAN_INCLUDE_DIRS_BITSERY_DEBUG}>)
    set_property(TARGET CONAN_PKG::bitsery PROPERTY INTERFACE_COMPILE_DEFINITIONS ${CONAN_COMPILE_DEFINITIONS_BITSERY}
            $<$<CONFIG:Release>:${CONAN_COMPILE_DEFINITIONS_BITSERY_RELEASE}>
            $<$<CONFIG:RelWithDebInfo>:${CONAN_COMPILE_DEFINITIONS_BITSERY_RELWITHDEBINFO}>
            $<$<CONFIG:MinSizeRel>:${CONAN_COMPILE_DEFINITIONS_BITSERY_MINSIZEREL}>
            $<$<CONFIG:Debug>:${CONAN_COMPILE_DEFINITIONS_BITSERY_DEBUG}>)
    set_property(TARGET CONAN_PKG::bitsery PROPERTY INTERFACE_COMPILE_OPTIONS ${CONAN_C_FLAGS_BITSERY_LIST} ${CONAN_CXX_FLAGS_BITSERY_LIST}
            $<$<CONFIG:Release>:${CONAN_C_FLAGS_BITSERY_RELEASE_LIST} ${CONAN_CXX_FLAGS_BITSERY_RELEASE_LIST}>
            $<$<CONFIG:RelWithDebInfo>:${CONAN_C_FLAGS_BITSERY_RELWITHDEBINFO_LIST} ${CONAN_CXX_FLAGS_BITSERY_RELWITHDEBINFO_LIST}>
            $<$<CONFIG:MinSizeRel>:${CONAN_C_FLAGS_BITSERY_MINSIZEREL_LIST} ${CONAN_CXX_FLAGS_BITSERY_MINSIZEREL_LIST}>
